...
export default function ConsignmentUploadForm({ order, onCancel, onSuccess }) {
  ...
  const handleSuccessModalClose = () => {
    ...
    // Pass orderId and imageLink to parent for optimistic update
    if (onSuccess) {
  ...
  return (
    <>
          ...
          {hasExistingImage && (
            <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-green-700 hover:text-green-900 underline flex items-center gap-2"
              >
        ...
        <div className="p-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-blue-800">
                  For authenticity, you must capture the consignment image using your device camera. Gallery/file uploads are disabled.
                </p>
              </div>
            </div>
          </div>

          {/* Hidden file input with camera only */}
          <input
            ref={fileInputRef}
            type="file"
            accept="image/*"
          ...
          {!capturedImage ? (
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
              <div className="flex flex-col items-center">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all shadow-sm flex items-center gap-2"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <button
                  onClick={handleOpenCamera}
                  className="flex-1 px-4 py-3 bg-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-300 transition-all flex items-center justify-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-purple-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm"
            >
      ...
      {/* Loading Modal - SEE NEXT FILE FOR REMAINING MODALS */}
      {uploading && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl p-8 max-w-sm w-full shadow-2xl">
            ...
            <p className="text-sm text-gray-600 text-center mb-6">
              Please wait while we upload your consignment image to Google Drive...
            </p>
          </div>
        </div>
      )}
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-slide-up">
          ...
          <div className="relative bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl">
            ...
            <p className="text-sm text-gray-600 text-center mb-6">
              Your consignment image has been uploaded to Google Drive and saved to the system.
            </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-4 bg-purple-50 border-2 border-purple-200 rounded-lg hover:bg-purple-100 transition-colors group mb-6"
            >
            ...
            <button
              onClick={handleSuccessModalClose}
              className="w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all shadow-sm"
            >
              Done
            </button>
          </div>
      ...
      {showErrorModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-slide-up">
          ...
          <div className="relative bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl">
            ...
            <p className="text-sm text-gray-600 text-center mb-6">
              There was an error uploading your consignment image.
            </p>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold rounded-lg hover:from-red-700 hover:to-red-800 transition-all shadow-sm disabled:opacity-50"
              >
                Try Again
              </button>
            </div>
